...
const sumEvens = evens.reduce((acc,val) => {
  return acc + val
});
...
//  using a higher order function, create an array of the unique  'weather_state_name'
//  values of the weather array. Your function should return the following array 
// ['Light Cloud', 'Heavy Cloud', 'Showers']

const states = weather.map((item) =>{
  return item.weather_state_name;
})
const threeWeather = (array)=> {
